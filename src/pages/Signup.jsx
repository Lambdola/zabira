...
function ProgressBar({ tabsLength = 5, backgroundProgress }) {
  return (
...
function Signup() {
  ...
  function handleInputChange(e) {
    ...
    let strength = 0;
    if (name === "password") {
      for (let validator in PASSWORD_VALIDATOR) {
              ...
              <div className="space-y-3">
                <div className="flex gap-4 items-center bg-[#F9F9FB] rounded-lg py-1 px-3">
                  ...
                  <div className="flex w-full items-center gap-2">
                    ...
                    {/* <div className="h-1 bg-[#E1E1E2] rounded-sm w-full"></div>
                    <div className="h-1 bg-[#DC2828] rounded-sm w-full"></div>
                    <div className="h-1 bg-[#E7B008] rounded-sm w-full"></div>
                    <div className="h-1 bg-[#16A249] rounded-sm w-full"></div> */}
                  </div>
                </div>
